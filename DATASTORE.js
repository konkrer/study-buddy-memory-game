...
const DATA = {
    'JavaScript': [
        ...
        {
            'question': 'What is an alternitive to listening for the DOMContentLoaded event?',
            answer: 'Inserting the word "defer" into a script tag.'
        },
        {
            'question': 'What is a Number.EPSILON?',
